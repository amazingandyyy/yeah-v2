...
var describeFieldArray = function describeFieldArray(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
      ...
      var TestArray = function TestArray(_ref3) {
        ...
        return _react2.default.createElement(
          ...
          fields.map(function (name) {
            return _react2.default.createElement(Field, { key: name, name: name + '.val', component: TestComponent });
          })
        );
      };
    ...
    it('should work with Fields', function () {
      ...
      var renderFields = (0, _expect.createSpy)(function (_ref21) {
        var foo = _ref21.foo;
        return _react2.default.createElement(
          'div',
          null,
      ...
      var component = (0, _expect.createSpy)(function (_ref22) {
    ...
    it('should get() actual current value from redux store', function () {
      ...
      var renderFieldArray = (0, _expect.createSpy)(function (_ref23) {
