...
var describeReduxForm = function describeReduxForm(name, structure, combineReducers, expect) {
  ...
  describe(name, function () {
    ...
    it('should not reinitialize values on remount if destroyOnMount is false', function () {
      ...
      var Container = function (_Component39) {
        _inherits(Container, _Component39);

        function Container() {
          _classCallCheck(this, Container);

          var _this50 = _possibleConstructorReturn(this, (Container.__proto__ || Object.getPrototypeOf(Container)).call(this));

          _this50.state = { showForm: true };
          return _this50;
        }
          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                'button',
                { onClick: function onClick() {
                    return _this51.setState({ showForm: !showForm });
                  } },
                'Toggle Form'
              )
            );
