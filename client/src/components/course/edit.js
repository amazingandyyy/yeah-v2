...
class CourseEditDetails extends Component{
    componentWillMount() {
...
export default connect(({course})=>{
    return {details: course.event}
}, actions)(CourseEditDetails);